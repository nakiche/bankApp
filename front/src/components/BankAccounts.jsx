      ...
      <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8 bg-[#F0F0F0] ">
        ...
        {addAccount && (
          <div className="sm:mx-auto sm:w-full sm:max-w-sm">
             ...
             {error && ( 
              <div className=" border bg-[#FFF5F5] text-[red] px-4 py-1 rounded relative text-center " role="alert">
            ...
            <div className="mt-2 ">
              ...
              >
                <div>
                  ...
                  <p style={{ fontSize: "15px", color: "red" }}>{errors.accountNumber}</p>
                </div>
        ...
        <div className="flex flex-row mt-10 justify-around  " key={b}	>
          ...
          <div className="font-bold flex items-center w-36" >
            ...
            <span><svg xmlns="http://www.w3.org/2000/svg" fill="currentcolor" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
